...
const ThreeDCard: React.FC<ThreeDCardProps> = ({ children, className }) => {
  return (
    <div className="relative overflow-visible rounded-xl">
      ...
      <div
        className={cn(
          "bg-gradient-to-l from-[#0e0d17eb] to-[#0d0f17c9] shadow-[inset_0_4px_10px_rgba(0,0,0,0.6)] rounded-xl border-r-[.3vh] border-b-[.2vh] border-t-[#bd96f4f8] border-[#1c1734a1] border-l-[#200f38f8] border-t-[.2vh] border-l-[.3vh]",
          className
        )}
      >
        {children}
