    ...
    <div className='px-[1vh] md:px-[calc(100%-84vw)] md:py-[3vw] py-[2vh] bg-gradient-to-b from-black to-[#0d0f17c9] min-h-screen'>
      ...
      <ThreeDCard className="w-full md:h-[20vw] h-[20vh] rounded-xl flex ">
        ...
        <div className="h-full md:py-[3vw] py-[3vh] w-2/3 md:text-[2.5vw] text-[2.3vh] font-[700] md:leading-[2.5vw] text-zinc-100 leading-[3vh] tracking-tight flex flex-col items-center text-center">
            <TextAnimate animation="blurInUp" by="character" className='leading-none'>Start Something Great</TextAnimate>
        ...
        <div className="w-1/3 h-full h-[] flex flex-col items-center justify-center relative">
        ...
        <div className='flex items-center justify-center shadow-lg shadow-[#000000] overflow-hidden'>
          ...
          <motion.div initial={{ y:-100, opacity: 0 }} animate={{ y:0, opacity: 1 }} transition={{ duration: 1 ,ease: 'easeInOut'}}>
          <Card col1='600073' col2='500073' className="absolute -translate-x-1/2 md:-translate-y-[9vw] md:w-[15vw] md:h-[8vw] w-[9vh] h-[6vh] px-2 pt-2 -translate-y-[6.8vh] md:px-[2vw] md:pt-[3vw] ">
